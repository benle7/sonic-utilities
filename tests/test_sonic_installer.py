...
def test_install(run_command, run_command_or_raise, get_bootloader, swap, fs):
    ...
    expected_call_list = [
        ...
        call(['mkdir', '-p', '/images/image_2/rw']),
        call(['mkdir', '-p', '/images/image_2/work']),
        call(['mkdir', '-p', '/tmp/image-image_2-fs']),
        call(['mount', 'overlay', '-t', 'overlay', '-o', 'rw,relatime,lowerdir=/tmp/image-image_2-fs,upperdir=/images/image_2/rw,workdir=/images/image_2/work', '/tmp/image-image_2-fs']),
        ...
        call(['umount', '-f', '-R', '/tmp/image-image_2-fs'], raise_exception=False),
